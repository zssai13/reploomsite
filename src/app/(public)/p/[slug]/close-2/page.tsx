...
export default async function ClosePage2({
  params,
}: {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* CTAs - Annual + Monthly Options */}
      <section className="py-10 px-6 lg:px-8">
        <div className="max-w-md mx-auto space-y-4">
          {/* Annual Package */}
          <div>
            <p className="text-center text-sm text-black/40 mb-3">
              Annual Package (Save 20%)
            </p>
            <a
          ...
          <div>
            ...
            <a
              href={page.downsellProductLink || '#'}
              className="inline-flex items-center justify-center w-full bg-white hover:bg-black/5 text-black font-semibold py-4 px-8 rounded-xl border border-black/10 transition-colors"
            >
              <span>Get Started - Monthly</span>
              {page.downsellProductPrice && (
                <span className="ml-2 text-black/40">— ${page.downsellProductPrice}/mo</span>
              )}
            </a>
          </div>
        </div>
      ...
      {/* Bottom CTAs - Annual + Monthly */}
      <section className="py-12 px-6 lg:px-8 border-t border-black/5">
        <div className="max-w-md mx-auto space-y-4">
          <p className="text-center text-sm text-black/40 mb-4">Ready to see real results?</p>
